    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/fertilizer', {
        ...
        headers: {
          ...
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4ODhjNmMwNTMxOGRjNjg1NjViNmUxNyIsImlhdCI6MTc1MzgxMjg2MSwiZXhwIjoxNzUzODE2NDYxfQ.TuSOb5m-4F5ErM-c_rzRgOYh3g_Z1pGANugjdTbIclI'
        },
